...
### Note
Check out the note here. Overleaf is no more useful!

<object data="/assets/files/00 main.pdf" type="application/pdf" width="100%" height="100%">
  <p>It appears your browser does not support PDF embedding. You can <a href="/assets/files/00 main.pdf">download the PDF</a> instead.</p>
</object>
